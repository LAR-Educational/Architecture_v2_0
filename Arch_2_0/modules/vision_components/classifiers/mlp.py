...
data_path = "modules/vision_components/classifiers/DBIM/alldb"

model_pxl = MLPClassifier(hidden_layer_sizes=(100,100,100),
			solver='sgd',learning_rate_init=0.01, 
			max_iter=500)

model_hst = MLPClassifier(hidden_layer_sizes=(100,100,100),
			solver='sgd',learning_rate_init=0.01, 
			max_iter=500)
...
def initializate(data_p = "modules/vision_components/classifiers/DBIM/alldb"):
	global data_path 
	data_path = data_p
