...
def users_group_eval(window, df,filename):
    ...
    #list_content_name = list_content_name["Name"].tolist()
    list_content_name = "meio_ambiente"#list_content_name["Name"].tolist()
...
if __name__=="__main__":
    users_group_eval("",pd.read_csv("/home/tozadore/Projects/Architecture_v2_0/Arch_2_1/Evaluations/Groups/Test1.csv"),"")